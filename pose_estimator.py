...
class RTMPose3D:
    def __init__(self, 
                ...
                detection_checkpoint_path: str, 
                estimator_config_path: str, 
                estimator_checkpoint_path: str):
        self.detection_config_path = detection_config_path
        self.detection_checkpoint_path = detection_checkpoint_path
        self.estimator_config_path = estimator_config_path
        self.estimator_checkpoint_path = estimator_checkpoint_path
